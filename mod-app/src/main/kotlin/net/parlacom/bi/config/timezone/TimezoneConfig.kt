 ...
 */
package net.parlacom.bi.config.timezone

import net.parlacom.common.library.datetime.DateTimeLib
import net.parlacom.common.library.logger.info
...
class TimezoneConfig {
    ...
    fun setTimeZone(): String {
        ...
        info("Current Date Time: " + DateTimeLib.dateTimeNow())
