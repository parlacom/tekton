...
import net.parlacom.bi.iot.domain.exception.error.ApiErrorCode.MC1103
 ...
 */
class InvalidStartDateTimeException : BusinessException {
    /**
     *
     */
    constructor() : super(MC1103)

    /**
     *
     */
    constructor(ex: Exception) : super(ex, MC1103)

    /**
     *
     */
    constructor(message: String) : super(message, MC1103)
}
