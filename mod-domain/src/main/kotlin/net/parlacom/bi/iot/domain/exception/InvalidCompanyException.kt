...
import net.parlacom.bi.iot.domain.exception.error.ApiErrorCode.MC1101
...
class InvalidCompanyException : BusinessException {
     ...
     *
     */
    constructor() : super(MC1101)

    /**
     *
     */
    constructor(ex: Exception) : super(ex, MC1101)

    /**
     *
     */
    constructor(message: String) : super(message, MC1101)
}
