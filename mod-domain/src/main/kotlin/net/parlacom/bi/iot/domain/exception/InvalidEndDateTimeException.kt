...
import net.parlacom.bi.iot.domain.exception.error.ApiErrorCode.MC1104
 ...
 */
class InvalidEndDateTimeException : BusinessException {
    /**
     *
     */
    constructor() : super(MC1104)

    /**
     *
     */
    constructor(ex: Exception) : super(ex, MC1104)

    /**
     *
     */
    constructor(message: String) : super(message, MC1104)
}
